...
def improved(new_route, duration, costs, best_cost, r, r_prime, requests, pas_cost, pack_cost, max_dur):
...
def opt2_first(routes, req_specs, cost, dur, pas_cost, pack_cost, max_dur):
            ...
            for idx, r in enumerate(route):        
                if idx == 0:
                    for idx_prime, r_prime in enumerate(route):
                        ...
                        improve = improved(replace_route, dur, cost, best_cost, r, r_prime, req_specs, pas_cost, pack_cost, max_dur)
                        count += 1
                        if improve:
