...
def Construct_sol_random(requests, dur, cost, servicetime, vehicle, max_serivce, pas_cost, pack_cost, max_duration):
            ...
            if not K: 
                ...
                for r, _ in enumerate(K):
                    if i[-1] == 0:
                        ...
                        del_pos = random.randint(pos+1, len(new_r))

                        new_r_del = new_r[:del_pos] + [i[-2],] + new_r[del_pos:]
